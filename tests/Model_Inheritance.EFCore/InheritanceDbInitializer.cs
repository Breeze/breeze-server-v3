...
namespace Inheritance.Models
{
    ...
    public class InheritanceDbInitializer
    {
        ...
        {
            // These tables now live alongside the other test models in the shared
            // BreezeTestDb, and are created by the database bootstrap script.
            // Dropping the database here (EnsureDeleted) would destroy the
            // Northwind and Produce data, so clear the rows instead.
