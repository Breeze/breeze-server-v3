...
namespace Breeze.Persistence {
  // The metadata classes below are populated by the metadata builders after construction
  // and then serialized. Members every builder sets are non-nullable and initialized to
  // null! (they are null only on an instance nobody has filled in yet); optional members
  // are nullable.
  ...
  public class BreezeMetadata {
    ...
    public List<MetaType> StructuralTypes { get; set; } = null!;
    /// <summary> Enum types used by entities and complex types; null if the model has none (EF builder) </summary>
  ...
  public class MetaEnum {
    ...
    /// <summary> Namespace of the enum; null for the global namespace </summary>
    public string? Namespace { get; set; }
    /// <summary> String values of the enum </summary>
    public string[] Values { get; set; } = null!;
    /// <summary> Int or string values of the enum </summary>
    public Array Ordinals { get; set; } = null!;
  }
  ...
  public class MetaType {
    ...
    public string ShortName { get; set; } = null!;
    /// <summary> Namespace of the type; null for the global namespace </summary>
    public string? Namespace { get; set; }
  ...
  public class MetaProperty {
    ...
    public string NameOnServer { get; set; } = null!;
  ...
  public class MetaDataProperty : MetaProperty {
    /// <summary> Type of the property: String, Int32, etc.  Null for a complex-type property. </summary>
